...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 72 "src/dot_parser.mly"
                                ( _1 :: _3 )
# 253 "src/dot_parser.ml"
               : 'list1_stmt))
; (fun __caml_parser_env ->
    Obj.repr(
# 76 "src/dot_parser.mly"
                ( () )
# 259 "src/dot_parser.ml"
               : 'semicolon_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 77 "src/dot_parser.mly"
                ( () )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 103 "src/dot_parser.mly"
                           ( _2 :: _3 )
# 347 "src/dot_parser.ml"
               : 'edge_rhs))
; (fun __caml_parser_env ->
    Obj.repr(
# 107 "src/dot_parser.mly"
                ( [] )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 117 "src/dot_parser.mly"
              ( _1, _2 )
# 383 "src/dot_parser.ml"
               : 'node_id))
; (fun __caml_parser_env ->
    Obj.repr(
# 121 "src/dot_parser.mly"
                ( None )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 142 "src/dot_parser.mly"
                           ( _2 :: _4 )
# 443 "src/dot_parser.ml"
               : 'attr_list))
; (fun __caml_parser_env ->
    Obj.repr(
# 146 "src/dot_parser.mly"
                ( None )
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 157 "src/dot_parser.mly"
              ( _1, Some _3 )
# 488 "src/dot_parser.ml"
               : 'equality))
; (fun __caml_parser_env ->
    Obj.repr(
# 161 "src/dot_parser.mly"
                ( () )
# 494 "src/dot_parser.ml"
               : 'comma_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 162 "src/dot_parser.mly"
                ( () )
