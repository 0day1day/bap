...
/* This header file was added to support the trace lifting     *
 * Some cleanup can be done to remove unnecessary declarations *
 *  - ethan                                                    */
...
#ifdef __cplusplus
// This is the only declaration from cfg.h that we need - ethan
