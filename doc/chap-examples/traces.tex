...
Also download PIN and extract it to the \cmdline{\$PATH/bap/pin}
...
the \cmdline{\$PATH/bap/libtracewrap/libtrace/protobuf/vsprojects}
...
prompt, navigate to
\cmdline{\$PATH/bap/libtracewrap/libtrace/src/cpp} and run
