...
_UNOP_TYPE = descriptor.EnumDescriptor(
  ...
  values=[
    descriptor.EnumValueDescriptor(
      name='uneg', index=0, number=1,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='unot', index=1, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_TMEM = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='element_type', full_name='tmem.element_type', index=1,
      number=2, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TMEM.fields_by_name['element_type'].message_type = _TYP
