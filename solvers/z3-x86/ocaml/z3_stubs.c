...
int camlidl_transl_table_z3_enum_6[123] = {
  Z3_OP_TRUE,
  Z3_OP_FALSE,
  Z3_OP_EQ,
  Z3_OP_DISTINCT,
...
{
value _v1;
  _v1 = camlidl_find_enum((*_c2), camlidl_transl_table_z3_enum_6, 123, "typedef Z3_decl_kind: bad enum  value");
  return _v1;
}
...
int camlidl_transl_table_z3_enum_8[2] = {
	...
	value _v_body)
{
  ...
  patterns = &_c1;
  camlidl_ml2c_z3_Z3_pattern(_v_patterns, &_c1, _ctx);
  num_decls = Int_val(_v_num_decls);
  sorts = &_c2;
  camlidl_ml2c_z3_Z3_sort(_v_sorts, &_c2, _ctx);
  decl_names = &_c3;
  camlidl_ml2c_z3_Z3_symbol(_v_decl_names, &_c3, _ctx);
  camlidl_ml2c_z3_Z3_ast(_v_body, &body, _ctx);
...
{
  return camlidl_z3_Z3_mk_quantifier(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8]);
}
	...
	value _v_formula)
{
  ...
  num_assumptions = Int_val(_v_num_assumptions);
  assumptions = &_c1;
  camlidl_ml2c_z3_Z3_ast(_v_assumptions, &_c1, _ctx);
...
{
  return camlidl_z3_Z3_benchmark_to_smtlib_string(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7]);
}
